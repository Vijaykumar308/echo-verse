...
export function NoResultsCard({ message, status = true, searchTerm, onClearSearch }) {
    return (
      <Card className="w-1/2 flex flex-col items-center justify-center p-6 text-center h-1/2 border-2 border-dashed border-[#0c2d54] bg-white">
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-[#0c2d54]">{message || "No Results Found"}</CardTitle>
        </CardHeader>
